...
def interface(img):
    ...
    for i, o in enumerate(pred):
        ...
        img_name = './static/result/test3.jpg'
        img.save(img_name, 'jpeg')
    return './static/result/test3.jpg'


if __name__ == '__main__':
    interface(r"C:\Users\Administrator\Desktop\PycharmFolder\Flowers_B03\flowerSR\data\test\1593801-rose-in.jpg")
